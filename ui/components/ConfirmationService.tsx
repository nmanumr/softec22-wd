...
import React, {
  createContext, Fragment, useContext, useRef, useState,
} from 'react';
...
export const ConfirmationServiceProvider = ({ children }: React.PropsWithChildren<{}>) => {
  ...
  const openConfirmation = (options: Options) => {
    setProps(options);
    setShow(true);
  ...
  return (
    <>
      ...
      <Transition.Root show={show} as={Fragment}>
        <Dialog
          as="div" className="fixed z-10 inset-0 overflow-y-auto" initialFocus={cancelButtonRef}
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                {apiError && <ErrorMessage error={apiError} className="mb-2" /> }
