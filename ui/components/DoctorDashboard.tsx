  ...
  return (
    <DashboardLayout>
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 overflow-hidden z-[3001]" onClose={closeSideBar}>
                                        ...
                                        <div className="sm:flex-1">
                                            <div>
                                                <div className="flex items-center">
                                                    <h3 className="text-xl font-bold text-gray-900 sm:text-2xl">{appointment['patient']['displayName']}</h3>
                                                </div>
                                            </div>
                                          {
                            ...
                            <div className="px-4 pt-5 pb-5 sm:px-0 sm:pt-0">
                                <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                    ...
                                    <div>
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">{format(new Date(appointment['time']), "dd/MM/yyyy - h:m a")}</dd>
                                    </div>
                                    <div>
                                        <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">Gender</dt>
                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">{appointment['patient']['gender'] ?? 'Unknown'}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
