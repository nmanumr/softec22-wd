    ...
    return (
        <CompactLayout title="Sign in to your account">
            <Form onSubmit={onSubmit} className="space-y-4">
                ...
                <FormField pattern={{value: /\+\d{12}/, message: 'Invalid Phone number'}} type="tel" name="phone" label={"Phone"}
                           required>
                    {({errors, label, ...props}: FormInputFuncProps) => (
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium text-gray-700">{label}</label>
                            <input
                                id="email" placeholder="+92 000 0000000" autoComplete="tel" {...props}
                ...
                <div className="flex items-center">
                    <div className="text-sm">
                        ...
                        <br/>
                        <LinkTo href="/accounts/forget_pass"
